                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 text-center">
                            <ul class="social-icons">
                                <li><a href="https://www.facebook.com/mediacargroup" class="fa fa-facebook"></a></li>
                                <li><a href="https://twitter.com/meidacar" class="fa fa-twitter"></a></li>
                                <li><a href="https://plus.google.com/u/0/" class="fa fa-google +"></a></li>
                                <li><a href="https://www.youtube.com/channel/UCu6QASWE-2fMXvVNmchDz9Q?disable_polymer=true" class="fa fa-youtube"></a></li>
                                @auth
                                    <li><a href="/home" class="fa fa-address-card">home</a></li>
                                @else
                                    <li><a href="/register" class="fa fa-address-card">تسجيل</a></li>
                                    <li><a href="/login" class="fa fa-address-card">دخول</a></li>
                                @endauth
                            </ul>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10 col-sm-10 main-menu text-right">
                                    ...
                                    <ul class="menu-first">
                                        ...
                                        <li><a href="#portfolio">ADVERTISEMENTS
</a></li>
                                        <li><a href="#our-team">CAPTAIN</a></li>
                    ...
                    <div class="flexslider">
                        <ul class="slides">
                            ...
                            <li>
                                ...
                                <div class="slider-caption visible-md visible-lg">
                                    <h2>mediacargroup.com</h2>
                                    <p>Your ad has continued</p>
                                </div>
                            </li>
                            <li>
                                <div class="overlay"></div>
                                ...
                                <div class="slider-caption visible-md visible-lg">
                                    <h2>Your ad works all day long</h2>
                                    <p>Your ad reaches all viewers</p>
                                </div>
                            </li>
                        </ul>
                    </div> <!-- /.flexslider -->
                ...
                <div class="row">
                        ...
                        <div class="service-item" id="service-1">
                            ...
                            <div class="service-content">
                                <div class="inner-service">
                                   <h3>CAPTAIN</h3>
                                   <p>نحن نعمل على تحسين دخلك بمجرد العمل معنا لمدة ثلاثة ساعات يومية بالعمل على التطبيق الخاص بنا وانت تقوم بعمل بالسيارة</p>
                                </div>
                            </div> <!-- /.service-content -->
                        </div> <!-- /#service-1 -->
                    </div> <!-- /.col-md-3 -->
                        ...
                        <div class="service-item" id="service-2">
                            ...
                            <div class="service-content">
                                <div class="inner-service">
                                   ...
                                   <p>دعنا نساعدك على نشر وترويج منتجك وخدماتك بنشر اعلاناتكم داخل سيارات تتنقل فى جميع انحاء الجمهورية طوال اليوم وعلى مدار الساعة حتى تحقق اكبر عدد مشاهدة</p>
                                </div>
                            </div> <!-- /.service-content -->
                        </div> <!-- /#service-1 -->
                    </div> <!-- /.col-md-3 -->
                    <div class="col-md-3 col-sm-6">
                        <div class="service-item" id="service-3">
                            <div class="service-icon">
                                <i class="fa fa-check-square Try it"></i>
                            </div> <!-- /.service-icon -->
                            <div class="service-content">
                                <div class="inner-service">
                                   <h3>coming soon</h3>
                    ...
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            ...
                            <div class="portfolio-overlay">
                                <h3>name company</h3>
                                <p>Field of Company.</p>
                                <a href="img/gallery/p1.jpg" data-rel="lightbox" class="expand">
                    ...
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            ...
                            <div class="portfolio-overlay">
                                <h3>name company</h3>
                                <p>Field of Company.</p>
                                <a href="img/gallery/p2.jpg" data-rel="lightbox" class="expand">
                                    <i class="fa fa-search"></i>
                                </a>
                            </div> <!-- /.portfolio-overlay -->
                        </div> <!-- /.portfolio-thumb -->
                    ...
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            ...
                            <div class="portfolio-overlay">
                                <h3>name company</h3>
                                <p>Field of Company.</p>
                                <a href="img/gallery/p7.jpg" data-rel="lightbox" class="expand">
                                    <i class="fa fa-search"></i>
                                </a>
                            </div> <!-- /.portfolio-overlay -->
                        </div> <!-- /.portfolio-thumb -->
                    ...
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            ...
                            <div class="portfolio-overlay">
                                <h3>name company</h3>
                                <p>Field of Company.</p>
                                <a href="img/gallery/p8.jpg" data-rel="lightbox" class="expand">
                                    <i class="fa fa-search"></i>
                                </a>
                            </div> <!-- /.portfolio-overlay -->
                        </div> <!-- /.portfolio-thumb -->
                    ...
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            ...
                            <div class="portfolio-overlay">
                                <h3>name company</h3>
                                <p>Field of Company.</p>
                                <a href="img/gallery/p3.jpg" data-rel="lightbox" class="expand">
                                    <i class="fa fa-search"></i>
                                </a>
                            </div> <!-- /.portfolio-overlay -->
                        </div> <!-- /.portfolio-thumb -->
                    ...
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            ...
                            <div class="portfolio-overlay">
                                <h3>name company</h3>
                                <p>Field of Company.</p>
                                <a href="img/gallery/p4.jpg" data-rel="lightbox" class="expand">
                                    <i class="fa fa-search"></i>
                                </a>
                            </div> <!-- /.portfolio-overlay -->
                        </div> <!-- /.portfolio-thumb -->
                    ...
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            ...
                            <div class="portfolio-overlay">
                                <h3>name company</h3>
                                <p>Field of Company.</p>
                                <a href="img/gallery/p5.jpg" data-rel="lightbox" class="expand">
                                    <i class="fa fa-search"></i>
                                </a>
                            </div> <!-- /.portfolio-overlay -->
                        </div> <!-- /.portfolio-thumb -->
                    ...
                    <div class="portfolio-item col-md-3 col-sm-6">
                        <div class="portfolio-thumb">
                            ...
                            <div class="portfolio-overlay">
                                <h3>name company</h3>
                                <p>Field of Company.</p>
                                <a href="img/gallery/p6.jpg" data-rel="lightbox" class="expand">
                                    <i class="fa fa-search"></i>
                                </a>
                            </div> <!-- /.portfolio-overlay -->
                        </div> <!-- /.portfolio-thumb -->
        ...
        <div class="content-section" id="our-team">
            <div class="container">
                <div class="row">
                    <div class="heading-section col-md-12 text-center">
                        <h2>Captain</h2>
                        <p>The best captain achieved the most watch time</p>
                    </div> <!-- /.heading-section -->
                </div> <!-- /.row -->
                <div class="row">
               ...
               <!-- <div class="row">
                ...
                <div class="row">
                    <div class="col-md-7 col-sm-6">
                        <p>يسعدنا تلقى مكالمتكم ورسائلكم طوال اليوم من خلال البريد الالكترونى اوخدمة الواتس اب
                   	  </p>
                      لتحميل التطبيق
                        <p>
                    ...
                    <div class="col-md-5 col-sm-6">
                        <div class="contact-form">
                            <form action="info@mediacargroup.com"  method="post" name="contactform" id="contactform">
                                <p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-xs-12 text-left">
                        <span>Copyright &copy; 2018 madia car group</span>
                  </div> <!-- /.text-center -->
